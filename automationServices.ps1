...
4.	Locate azure virtual networks tab in Azure preview portal and create a virtual network. Set the name of virtual network to 
...
$Subnet1Adress="172.16.1.0/24"
$Subnet2Name="MySubnet2"
$Subnet2Adress="172.16.2.0/24"
$VnetName="MyVnet"
...
function createNetworks{
    ...
    $subnets+= New-AzureRmVirtualNetworkSubnetConfig -Name $Subnet2Name -AddressPrefix $Subnet1Address
